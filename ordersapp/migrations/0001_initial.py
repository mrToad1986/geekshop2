# Generated by Django 3.2.4 on 2022-01-16 13:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлено в обработку'), ('PRD', 'обработано'), ('PD', 'оплачено'), ('CLN', 'отменено'), ('DN', 'завершено')], default='FM', max_length=3)),
