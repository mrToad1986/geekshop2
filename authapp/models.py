...
NULLABLE = {'blank': True, 'null': True} #словарь для быстрого заполнения полей
...
class ShopUserProfile(models.Model):
    ...
    lang = models.CharField(max_length=128, **NULLABLE, verbose_name='Родной язык')

    #декораторы для обработки сигналов нового пользователя
